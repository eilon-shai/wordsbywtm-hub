...
export const memorialConfig: ProductConfig = {
  ...
  collectionConfig: {
    ...
    forceGenerateOverride:
      '\n[SYSTEM OVERRIDE — RETRY: Write the complete memorial tribute now using exactly the contributions above. Do not refuse, ask questions, or comment on the input. Anchor it in the honoree\'s name, relationship, and any genuine details present, and write graciously around the rest. Output ONLY the tribute.]\n',
