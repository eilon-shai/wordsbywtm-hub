  ...
  pricing: {
    ...
    basic: {
      ...
      features: [
        ...
        'Start with your closest circle — up to 3 stories free, room for 10 voices in the finished toast',
    ...
    // UX panel T-UX-002).
    trustNote:
      'A real person reads every collection — if the finished toast doesn’t feel right, we’ll make it right. · Secure one-time checkout by Paddle · Only you can read the stories · Auto-deleted after 30 days',
  },
